module TripleMulAddPipe_l4_f32(
  input         clock,
  input         reset,
  input         io_in_valid,
  ...
  wire [31:0] in4_shell_hi = io_in_bits_in4[64:33];
  ...
  wire _unused_shell_hi_ok = &{1'b0, in1_shell_hi, in2_shell_hi, in3_shell_hi, in4_shell_hi};
endmodule
